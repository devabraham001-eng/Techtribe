    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="paths-wrapper" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <img
          ...
          style={{ position: "absolute", bottom: 320, right: -20, width: 140, height: 140, pointerEvents: "none", zIndex: 0, opacity: 0.03 }}
              ...
              {tracks.length === 0 ? (
                ...
                tracks.map((track) => (
                  <motion.a
                    ...
                    className="group flex aspect-square w-full flex-col justify-between rounded-3xl border p-6 transition-all duration-200 hover:border-[#4a4a4c] hover:bg-[#222224] hover:shadow-lg"
        ...
        {/* ===== EXPLORE ===== */}
        <motion.section
          className="explore text-center pb-16"
          style={{ position: "relative", zIndex: 1 }}
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        <motion.section
          ...
          style={{ position: "relative", zIndex: 1, background: "#0a0a0a" }}
          initial={{ opacity: 0 }}
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center relative">
            <motion.div
              className="continue-img flex justify-center mb-6"
              style={{ opacity: 0.15 }}
